...
export const PURCHASE_CREDIT_PAYMENT_STATUS_TRANSITIONS = Object.freeze({
  [PURCHASE_CREDIT_PAYMENT_STATUSES.IN_PROGRESS]: Object.freeze([
    PURCHASE_CREDIT_PAYMENT_STATUSES.PAID,
    PURCHASE_CREDIT_PAYMENT_STATUSES.FAILED,
    PURCHASE_CREDIT_PAYMENT_STATUSES.REFUND,
  ]),
  [PURCHASE_CREDIT_PAYMENT_STATUSES.PAID]: Object.freeze([
    PURCHASE_CREDIT_PAYMENT_STATUSES.REFUND,
  ]),
  [PURCHASE_CREDIT_PAYMENT_STATUSES.FAILED]: Object.freeze([
    PURCHASE_CREDIT_PAYMENT_STATUSES.REFUND,
  ]),
  [PURCHASE_CREDIT_PAYMENT_STATUSES.REFUND]: Object.freeze([]),
});
