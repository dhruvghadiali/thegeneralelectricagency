...
function TallyTabs() {
  return (
    <Tabs defaultValue="companies" className="flex min-h-0 w-full flex-1 flex-col">
      ...
      <TabsContent value="companies" className="min-h-0 flex-1 data-[state=active]:flex data-[state=active]:flex-col">
        <Companies />
      </TabsContent>
      <TabsContent value="products" className="min-h-0 flex-1 data-[state=active]:flex data-[state=active]:flex-col">
        <Products />
      </TabsContent>
    </Tabs>
  );
